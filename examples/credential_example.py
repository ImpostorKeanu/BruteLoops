...
config.authentication_callback = fake

# ============================
# AUTHENTICATION CONFIGURATION
# ============================
config.process_count =  1   # Maximum number of processes to use 
config.max_auth_tries = 2   # Max number of auth attempts before sleeping
config.stop_on_valid = True # Stop after valid credentials are recovered

# ====================
# JITTER CONFIGURATION
# ====================
config.authentication_jitter = Jitter(min='1s',max='1s') 
config.max_auth_jitter = Jitter(min='32m',max='38m')     

# ====================
# OUTPUT CONFIGURATION
# ====================
config.db_file = 'cred_brute.sqlite'    
...
config.log_file = 'cred_brute_log.txt'
...
try:
    ...
    bf = Credential(config)
    bf.launch(['testo,presto','testo2,presto2','administrator,P@ssw0rd'])
