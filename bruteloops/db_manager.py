...
#                new_password, password = self.goc(sql.Password, password)
#
...
#                        ).first()
#
#                # Make the password non-sprayable if it's new,
#                # ensuring that brute.py will not pull it during
#                # execution
#                if credential and new_password:
#                    credential.sprayable = False
#
